...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			songs.push(new SongMetadata(initSonglist[i], 1, 'gf', FlxColor.fromRGB(146, 113, 253)));
		}
		...
		addWeek(['Paintball', 'Allstar', 'Wet-Paint'], 1, ['scarlett'], FlxColor.fromRGB(118, 24, 80));
		addWeek(['Rendezvous', 'Sawgrinder', 'Russian-Rundown'], 2, ['velvet'], FlxColor.fromRGB(192, 24, 12));
		// addWeek(['Cold-Cuts', 'Zeus', 'Blizzard'], 3, ['gf']);
		...
		for (i in 0...songs.length)
		{
			...
			songText.forceX = songText.x - (icon.width / 2);
